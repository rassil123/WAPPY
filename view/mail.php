...
--rich-black-fogra-39: hsl(250deg 15% 8%)
...
--gradient-1: linear-gradient(150deg, var(--indigo) 0%, var(--han-purple) 78%); /*background: rgb(123,117,231);
background: linear-gradient(122deg, rgba(123,117,231,1) 5%, rgba(69,145,235,1) 41%, rgba(144,123,242,1) 85%, rgba(190,109,246,1) 96%);*/
...
/*************************************************************************/
  ...
  body{
    max-size=200px;
      ...
      background: -webkit-linear-gradient(150deg, hsl(277, 94%, 28%) 0%, hsl(250, 72%, 51%) 78%); /* Chrome 10-25, Safari 5.1-6 */
      background: linear-gradient(150deg, hsl(277, 94%, 28%) 0%, hsl(250, 89%, 44%) 78%); }
 ...
 label
 {
  ...
  #sendBtn{
    ...
    background-image:linear-gradient(150deg, hsl(277, 94%, 28%) 0%,rgb(0, 32, 238), hsl(250, 72%, 51%) 78%);
    padding:.5rem;
    color:white;
    margin:1rem 0;
    width:auto;
  ...
  #sendBtn:active{
    ...
    color: linear-gradient(150deg, hsl(277, 94%, 28%) 0%, hsl(250, 72%, 51%) 78%);
...
<h2 class="h1 hero-title" style="
    margin-left: 110px;">Welcome</h2>

<p class="hero-text">
<b>You have been successfully registred</b></p>
<p class="hero-text">
<b>Discover a new way of trading  NFTs</b></p>

<a href="localhost/Projetweb/index.php" target="_blank" id="sendBtn" name="submit">Start the new experience</a>
