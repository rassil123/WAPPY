    ...
    <article>
      ...
      <section class="section explore" id="explore">
       ...
       <table>
        ...
        <tr>
        <td width="40%">
            <img src="<?php echo $_GET["liennfttoswapwith"]?>" height="55%" width="89%">
        </td>
       ...
       <form action="../controller/ajout_annonces.php" method="post" >
          ...
          <input type="hidden" name="type" value="ajoutechange" >
          ...
          <input type="hidden" name="namenfttoswapwith" <?php echo("value=".$_GET['namenft']."")?>>

          <input type="hidden" name="liennfttoswapwith" <?php echo("value=".$_GET['liennfttoswapwith']."")?>>

          <input type="hidden" name="idusergiver" <?php echo("value=".$_SESSION['useremail']."")?>>

          <input type="hidden" name="idusergetter" <?php echo("value=".$_GET['usergiver']."")?>>
