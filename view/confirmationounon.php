...
$display = $init_admin->listnftaconfirmer($_SESSION['useremail']);
          ...
          <?php
            ...
            <li>
              ...
              <div class="card explore-card">
                ...
                <figure class="card-banner" style="margin-top: 15px;">
                  <a href="#">
                    <img src="<?= $produit['lientoget']?>" width="600" height="600" loading="lazy"
                      alt="Walking On Air" class="img-cover">
                  </a>
                </figure>
<!--
                ...
                <a  onclick="if (confirm('vous allez etre rediregee de page')){return true;}else
                
                {event.stopPropagation(); event.preventDefault();};
                
                " href="transaction2.php?liennfttoswapwith=<?php echo $produit['lien'];?>&usergiver=<?php echo $produit['idusergiver'];?>&namenft=<?php echo $produit['namenft'];?>&lientoaccept=<? echo $produit['lientoget'];?>">
