    ...
    <article>
      ...
      <section class="section explore" id="explore">
       ...
       <form action="../controller/ajout_annonces.php" method="post" >
          ...
          <h2 style="padding-bottom: 15px;">Share what you think</h2>
          <input type="hidden" name="type" value="forum">

          <input type="text" placeholder="Post" name="question" class="newsletter-input" required minlength="8" maxlength="8" style="margin-bottom: 15px;">

          <input type="text"  placeholder="Entrer NFT Link "  name="lien" class="newsletter-input"  required>

          <input type="hidden" name="userposteur" <?php echo("value=".$_SESSION['useremail']."")?>>
